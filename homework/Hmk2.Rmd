...
```{r}
ggplot(df, aes(length, year, fill=length)) +
  geom_tile() +
  coord_equal()
```
...
3. `d` and `a` feel the same. They both communicate that there's a gap in data. However, with both graphs its more difficult to see how the data is spread.
