...
* What this means for continuos data, if right="TRUE", is when a bin is (4, 8] and a continuos number 8.4 appears, it'll go into that bin. If a bin is [4,8) and a 8.4 appears, it'll go into the next bin. *
...
* 53605 out of 58,788 movies have "N/A" for their buget. That leaves 5,183 with a recorded budget. Outside of the handful of movies that hit 1 billion in their budget, the rest of the movies don't appear to differ much in their budget. I would not be suprised if there are rounding errors. *
