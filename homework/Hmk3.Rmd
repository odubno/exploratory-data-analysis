...
1. It's hard to tell if there's a pattern in missing data. According to *Missing Data by County* we could see that NYC under reports their values.
2. However, there's a lot of points clustered around NYC, and of course some of those will unreported. 
3. There's a lot of variety in missing values across the stations.
...
4. The missing data is highly problematic in capturing true snowfall patterns.
